...
export default {
  darkMode: ["class"],
  // index.html carries the pre-hydration hero shell, so its classes must be generated too.
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        registrar: {
          cloudflare: "hsl(var(--registrar-cloudflare))",
          godaddy: "hsl(var(--registrar-godaddy))",
          ovhcloud: "hsl(var(--registrar-ovhcloud))",
          "ovhcloud-surface": "hsl(var(--registrar-ovhcloud-surface))",
          porkbun: "hsl(var(--registrar-porkbun))",
          spaceship: "hsl(var(--registrar-spaceship))",
          namecheap: "hsl(var(--registrar-namecheap))",
        },
        mint: "hsl(var(--aurora-mint))",
        violet: "hsl(var(--aurora-violet))",

      ...
      {!hasQuery ? (
        <div className="relative z-10 flex min-h-[38vh] items-center justify-center px-4 pb-4 pt-10 sm:h-[calc(50vh-72px)] sm:min-h-0 sm:pb-0 sm:pt-0">
          <div className="mx-auto w-full max-w-5xl text-center">
            <Link
              to="/speed"
              className="hero-chip mb-5 inline-flex max-w-full items-center gap-2 rounded-full border px-4 py-1.5 text-[11px] text-muted-foreground transition-colors hover:text-foreground sm:text-xs"
            >

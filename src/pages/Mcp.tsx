      ...
      <div className="min-h-screen bg-background relative overflow-hidden">
        ...
        <main className="container mx-auto px-4 py-16 max-w-[968px]">
          ...
          <section className="mb-20">
            <div className="rounded-2xl border border-border bg-card/40 backdrop-blur-xl overflow-hidden shadow-2xl shadow-primary/5">
              {/* Window chrome */}
              <div className="flex items-center justify-between px-4 py-3 border-b border-border/60 bg-card/60">
                ...
                <span className="text-xs text-muted-foreground font-mono">Claude · domain-check-skills</span>
                <span className="w-12" />
              </div>
              ...
              <div className="p-6 md:p-8 space-y-5">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 pt-1">
                    <p className="text-sm md:text-base">
                      Is <span className="font-mono text-primary">acme.io</span> available? If not, suggest 5 alternatives under $20/year.
                    </p>
                  </div>
                </div>
                {/* assistant */}
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 space-y-3 pt-1">
                    <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-md bg-primary/10 border border-primary/20 text-xs font-mono">
                      <Terminal className="w-3 h-3" />
                      check_domain · search_domains · get_registrars
                    </div>
                    <p className="text-sm md:text-base text-muted-foreground">
                      <span className="font-mono text-foreground">acme.io</span> is{" "}
                      <span className="text-red-400 font-semibold">taken</span>. Here are 5 available under $20/yr:
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                      {[
                        ["tryacme.io", "$17.98", "Porkbun"],
                        ["acme.dev", "$12.50", "Cloudflare"],
                        ["getacme.co", "$11.99", "Namecheap"],
                        ["acme.app", "$14.00", "Cloudflare"],
                        ["acmehq.io", "$19.95", "Dynadot"],
                      ].map(([d, p, r]) => (
                        <div
                          key={d}
                          className="flex items-center justify-between px-3 py-2 rounded-lg bg-background/60 border border-border/60"
                        >
